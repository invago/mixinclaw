...
2. 复制到 OpenClaw extensions 目录：
   ...
   - macOS/Linux: `~/.nvm/versions/node/*/lib/node_modules/openclaw/extensions/mixin`
...
- 每个机器人可以创建多个 Session，建议为不同环境创建不同的 Session
...
```json
{
  "channels": {
    "mixin": {
      ...
      "sessionPrivateKey": "...",
      "allowFrom": [
        "aef61d54-4932-4e72-8186-a6dccfadee5a",
        "b2f74d8c-1a3e-4f9b-8c6d-5e2a1b9c8d7f"
      ]
    }
  }
}
