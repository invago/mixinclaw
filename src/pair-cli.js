...
const { getPendingPairing, completePairing, listPendingPairings } = require('./pairing-store.js');
...
function help() {
  ...
  console.log('');
  console.log('Usage:');
  console.log('  npm run pairing <code>     - Approve a pairing code');
  console.log('  npm run pairing list       - List pending pairings');
  console.log('  npm run pairing help       - Show this help');
}
